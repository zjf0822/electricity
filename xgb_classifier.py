...
model.save_model('/home/zhoujifa/competition/baidu_elecrticity/model/xgb.model')  # 用于存储训练出的模型
print("best best_ntree_limit", model.best_ntree_limit)

preds = model.predict(xgb_test, ntree_limit=model.best_ntree_limit)

np.savetxt('/home/zhoujifa/competition/baidu_elecrticity/xgb_submission.csv', np.c_[range(1, len(test) + 1), preds], delimiter=',', header='ImageId,Label', comments='', fmt='%d')
